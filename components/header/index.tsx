        ...
        <header className="px-4 bg-[#232536]">
            <div className="container flex justify-between h-16 mx-auto">
                ...
                <ul className="items-center text-white hidden space-x-3 md:flex">
                    ...
                    <li className="flex">
                        <a rel="noopener noreferrer" href="#" className="flex font-light items-center px-4 -mb-1  dark:border-transparent">Blog</a>
                    </li>
                    <li className="flex">
                        <a rel="noopener noreferrer" href="#" className="flex font-light items-center px-4 -mb-1  dark:border-transparent dark:text-violet-400 dark:border-violet-400">About Us</a>
                    </li>
                    <li className="flex">
                        <a rel="noopener noreferrer" href="#" className="flex font-light items-center px-4 -mb-1  dark:border-transparent">Contact Us</a>
                    </li>
                    <li className="flex">
